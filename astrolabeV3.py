...
TAILLE=500
# Le diametre du de la sphere celesste
R=1
...
decalages={50.7333:[9,18.1,30.8,40.15,48.2,57.5,67,78.2,88.3],44:[6.5,16.8,30.4,40.15,48.2,57.65,67.4,79.25,91],46:[6.5,16.8,30.4,40.15,48.2,57.65,67.4,79.25,91],60:[14,22,32.6,41,48.42,57.1,65.55,75.5,84]}
decalsup={50.7333:[58.6,62,65.5,68.6,71.55,74.4,77.4,80.35,83.4,86.7,90.2],44:[58.6,62.4,65.5,68.6,71.55,74.4,77.4,80.3,83.4,86.5,90],46:[58.6,62.4,65.5,68.6,71.55,74.4,77.4,80.3,83.4,86.5,90],
          60:[59,62.3,65.3,68.4,71.3,74.3,77.4,80.4,83.6,86.4,90]}
decaldroit={50.7333:[12.485,97.13,95.561,94.1,92.59],44:[7.2,17.27,96.85,95.15,93.45],46:[7.2,17.27,96.85,95.15,93.45],
            60:[96.38,95,93.8,92.7,91.5]}
decalgauche={50.7333:[86.2,51.7,52.9,54.1,54.8],44:[91.3,81.32,51.6,53.18,54.18],46:[91.3,81.32,51.6,53.18,54.18],60:[52.62,53.6,54.5,55.3,55.7]}
from math import *
...
def tympan(x):
    ...
    pied="</svg>\n"
    image=open("tympan"+str(int(PHI))+"V2.svg","w")
    image.write(entete)
    ...
    image.write(texte("Latitude "+str(PHI),"capricorne",offset=23))
...
def dos(x):
    ...
    for i in range(366):
        image.write(ligne(punkts[i],punkts[(i+1)%366]))
    ...
    image.write(cartouche(0,-25*x/20.0+0.04,"Anno MMXX"))
    ...
    for i in range(0,180):
         ...
         siny=-sin(2*pi*i/360)
         if (i%10==0):
          image.write(ligne((cosy*maxhor,siny*maxhor),(cosy*maxhor*0.97,siny*maxhor*0.97)))
         elif (i%5==0):
          image.write(ligne((cosy*maxhor,siny*maxhor),(cosy*(maxhor*0.96),siny*(maxhor*0.96))))  
         else:
          image.write(ligne((cosy*maxhor,siny*maxhor),(cosy*(maxhor*0.988),siny*(maxhor*0.988))))
    image.write(ligne((-maxhor,0),(-maxhor*0.97,0)))
